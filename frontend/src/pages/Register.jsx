...
import { ChefHat, User, Mail, Lock, Eye, EyeOff, Loader2 } from 'lucide-react';
      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-slate-200/50 bg-white p-8 shadow-xl dark:border-slate-800/50 dark:bg-slate-900 transition-colors duration-300">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
            Join the CookVerse AI cooking community
          </p>
        </div>
        ...
        {success && (
          <div className="rounded-lg bg-green-50 p-3 text-sm font-medium text-green-600 dark:bg-green-950/20 dark:text-green-400">
            {success}
          </div>
        )}
        ...
        <div className="text-center text-sm text-slate-500 dark:text-slate-400">
          ...
          <Link to="/login" className="font-semibold text-amber-500 hover:text-amber-600 hover:underline">
            Login here
          </Link>
        </div>
      </div>
